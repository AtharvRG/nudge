...
export function OnboardingDialog() {
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (!success) {
                setError("Failed to create account. Please try again or use a stronger PIN.");
            }
        } catch (err) {
                    ...
                    <form onSubmit={handleNext} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                required
                            />
                            <p className="text-xs text-zinc-500">4-6 digits. Avoid patterns like 1234 or 1111.</p>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                onKeyPress={(e) => {
                                    ...
                                    if (e.key === 'Enter' && confirmPin.length >= 4) {
                                        e.preventDefault();
