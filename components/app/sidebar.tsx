    ...
    return (
        <div className="w-64 h-screen border-r border-white/5 bg-zinc-950 flex flex-col hidden md:flex sticky top-0 overflow-y-auto">
            ...
            <div className="p-6 flex items-center gap-3">
                ...
                <span className="font-display text-2xl text-white tracking-widest">NUDGE</span>
            </div>
            ...
            <div className="mt-auto p-6 border-t border-white/5 bg-white/[0.02]">
                <button
                    onClick={logout}
                    className="flex w-full items-center justify-center gap-3 px-4 py-4 rounded-2xl bg-zinc-900 border border-white/10 text-zinc-400 hover:text-red-400 hover:border-red-400/50 transition-all font-body text-sm tracking-[0.1em]"
                >
