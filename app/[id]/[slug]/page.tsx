...
export default function PublicPaymentPage() {
    ...
    return (
        ...
        <div className="min-h-screen bg-[#050505] text-white flex flex-col items-center justify-center p-6 relative overflow-hidden">
            ...
            {/* Logo Header */}
            <div className="mb-2 flex flex-row items-center gap-4 animate-in fade-in slide-in-from-top-4 duration-1000">
                ...
                <h2 className="text-2xl md:text-4xl font-display tracking-[0.1em] text-white/50 uppercase whitespace-nowrap">Secured by Nudge</h2>
            </div>
                ...
                <div className="bg-zinc-900/40 backdrop-blur-3xl border border-white/10 rounded-[2.5rem] p-8 md:p-10 shadow-2xl overflow-hidden relative">
                    ...
                    {payStatus === 'success' ? (
                        <div className="text-center py-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            ...
                            <h2 className="text-4xl font-display mb-2">Payment Sent!</h2>
                            <p className="text-zinc-500 mb-10 leading-relaxed font-medium">Your transaction has been privately compressed into the recipient's pool.</p>
                            <Button
                                onClick={() => router.push("/")}
                                className="w-full h-16 rounded-2xl bg-white text-black text-2xl hover:text-white hover:bg-yellow-400 transition-all flex items-center justify-center gap-2"
                            >
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-black/40 border border-white/5 rounded-3xl p-6 flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                    <div className="w-10 h-10 rounded-full bg-neon-pink/10 flex items-center justify-center">
                                        <Coins className="w-7 h-7 text-neon-pink" />
                                    </div>
                                    <p className="font-display text-3xl text-zinc-300">Amount to send</p>
                                </div>
                                <div className="text-right">
                                    <input
                                        ...
                                        className="bg-transparent border-none text-right font-mono text-3xl text-white placeholder:text-zinc-800 w-32 focus:ring-0 outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                                    />
                            ...
                            {publicKey && !isAuthenticated && (
                                <div className="bg-black/40 border border-white/5 rounded-3xl p-6 space-y-4">
                                    <div className="flex items-center justify-between">
                                        <p className="font-display text-2xl text-zinc-200">Secure Access</p>
                            ...
                            {!publicKey ? (
                                ...
                                <Button
                                    ...
                                    className="w-full h-18 rounded-3xl bg-white/90 hover:bg-[#37b0c8] hover:text-white text-black font-display text-2xl tracking-[0.1em] transition-all active:scale-95 flex items-center justify-center gap-3 border-none"
                                >
                            ...
                            <div className="pt-4 flex items-center justify-center gap-4 opacity-30 grayscale hover:grayscale-0 transition-all duration-700">
                                <span className="text-[10px] uppercase italic font-black tracking-[0.3em]">Powered by</span>
                                <div className="h-4 w-px bg-white/20" />
                                <span className="text-[10px] uppercase font-body text-bg-green tracking-[0.3em]">Light Protocol</span>
                                <div className="h-4 w-px bg-white/20" />
                                <span className="text-[10px] uppercase font-body tracking-[0.3em]">Helius</span>
                            </div>
                        </div>
                    )}
                </div>
            ...
            <footer className="mt-12 relative z-10">
                <p className="text-m text-zinc-700 font-medium">Privacy is a human right. Protected by Nudge.</p>
            </footer>
        </div>
        {(payStatus === "signing" || payStatus === "confirming") && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
                <div className="bg-zinc-900/80 border border-white/10 rounded-2xl p-6 w-full max-w-sm text-center space-y-3">
                    ...
                    <h3 className="text-white font-display text-3xl">Confirm in your wallet</h3>
