...
export default function PricingPage() {
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            {/* Header */}
            <div>
                <h1 className="text-5xl font-display text-white mb-2">Plans <span className="text-[#00aac8]">& Pricing</span></h1>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 mt-8">
                ...
                <div className="relative p-8 rounded-2xl bg-zinc-900 border-2 border-neon-pink flex flex-col gap-6 shadow-[0_0_20px_rgba(247,39,152,0.1)]">
                    <div className="absolute top-0 right-0 bg-neon-pink text-white text-xs font-bold px-3 py-1 rounded-bl-lg font-mono uppercase tracking-wider">Current Plan</div>
                    <div>
                    ...
                    <Button variant="outline" disabled className="w-full opacity-50 cursor-not-allowed uppercase font-bold tracking-widest text-xl">Active</Button>
                </div>
                ...
                <div className="p-8 rounded-2xl bg-zinc-900/40 border border-white/5 flex flex-col gap-6 opacity-60 hover:opacity-100 transition-all duration-300 hover:border-white/20">
                    ...
                    <Button variant="outline" disabled className="w-full uppercase font-bold tracking-widest text-xl">Coming Soon</Button>
                </div>
                ...
                <div className="p-8 rounded-2xl bg-zinc-900/40 border border-white/5 flex flex-col gap-6 opacity-60 hover:opacity-100 transition-all duration-300 hover:border-white/20">
                    ...
                    <Button variant="outline" disabled className="w-full uppercase font-bold tracking-widest text-xl">Contact Sales</Button>
                </div>
            </div>
        </div>
    )
